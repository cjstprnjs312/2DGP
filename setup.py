...
resources_Music = ['./Music/'+ file_name for file_name in os.listdir('./Music/')]
resources_resource = ['./resource/'+ file_name for file_name in os.listdir('./resource/')]
resources_font = ['./font/'+ file_name for file_name in os.listdir('./font/')]
...
setup(name="name",
      windows=[mygame],
       data_files=[('./Music/', resources_Music), (sdl_folder, sdl_dlls)] + [('./resource/', resources_resource), (sdl_folder, sdl_dlls)] +
                 [('./font/', resources_font), (sdl_folder, sdl_dlls)] ,
